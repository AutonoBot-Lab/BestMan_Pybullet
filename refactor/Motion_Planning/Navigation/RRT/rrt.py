...
class RRTPlanner:
    ...
    def plan(self, start_pose, goal_pose):
        ...
        self.area = self.AreaBounds(start_position, goal_position, self.obstacles_bounds)
    ...
    def draw_graph(self, rnd=None):
        ...
        if rnd is not None:
            ...
            if self.robot_radius > 0.0:
                ...
                self.plot_rectangle(rnd.x-self.robot_radius, rnd.y-self.robot_radius, rnd.x+self.robot_radius, rnd.y+self.robot_radius)
        ...
        for (x_min, y_min, x_max, y_max) in self.obstacles_bounds:
            ...
            self.plot_rectangle(x_min, y_min, x_max, y_max)
