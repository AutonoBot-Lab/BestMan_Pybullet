...
class PRMPlanner:
    ...
    def plan(self, sx, sy, gx, gy):
        ...
        sample_x, sample_y = self.sample_points(sx, sy, gx, gy, self.rng)
        plt.plot(sample_x, sample_y, ".b")
        road_map = self.generate_road_map(sample_x, sample_y)
        rx, ry = self.dijkstra_planning(sx, sy, gx, gy, road_map, sample_x, sample_y)

        return rx, ry
    
    def visual(self,sx,sy,gx,gy,rx,ry):
        """
...
def main(rng=None):
    ...
    rx, ry = prm.plan(sx,sy,gx,gy)
    prm.visual(sx,sy,gx,gy,rx,ry)
